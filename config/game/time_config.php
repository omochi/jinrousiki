...
class TimeConfig {
  ...
  static $sudden_death = 120; //180;

  //サーバダウン判定時間 (秒)
  //超過のマイナス時間がこの閾値を越えた場合はサーバが一時的にダウンしていたと判定して、
  //超過時間をリセットします
  static $server_disconnect = 90;

  //警告音開始 (秒) (超過の残り時間がこの時間を切っても未投票の人がいたら警告音が鳴ります)
  static $alert = 90;

  //警告音感覚 (秒) (警告音の鳴る間隔)
  static $alert_distance = 6;

  //-- リアルタイム制 --//
  static $default_day   = 5; //昼の制限時間の初期値 (分)
  static $default_night = 3; //夜の制限時間の初期値 (分)
  ...
  static $silence_pass = 8;

  static $wait_morning = 15; //早朝待機制の待機時間 (秒)
}
