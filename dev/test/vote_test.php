...
$RQ_ARGS->TestItems->test_users[2]->role = 'trap_wolf strong_voice rebel';
...
$RQ_ARGS->TestItems->test_users[6]->role = 'dummy_priest liar possessed[3-15]';
...
$RQ_ARGS->TestItems->test_users[9]->role = 'revive_cat mind_open joker[4]';
...
$RQ_ARGS->TestItems->test_users[10]->role = 'assassin mind_friend[21]';
...
$RQ_ARGS->TestItems->test_users[14]->role = 'poison_fox lovers[16] death_warrant[3]';
...
$RQ_ARGS->TestItems->test_users[15]->role = 'possessed_mad possessed_target[3-6] lost_ability';
...
$RQ_ARGS->TestItems->test_users[17]->role = 'attempt_necromancer possessed[3-3] febris[3] bad_luck';
...
$RQ_ARGS->TestItems->test_users[18]->role = 'weather_priest';
...
$RQ_ARGS->TestItems->test_users[21]->role = 'sacrifice_mania[24] mind_friend[21]';
...
$RQ_ARGS->TestItems->test_users[22]->role = 'psycho_escaper disfavor';
...
$RQ_ARGS->TestItems->test_users[23]->role = 'phantom_doll';
...
$RQ_ARGS->TestItems->test_users[24]->role = 'barrier_wizard watcher mind_friend[21] protected[21]';
...
$RQ_ARGS->TestItems->vote->night = array(
  ...
  array('uname' => 'light_gray', 'situation' => 'WOLF_EAT', 'target_uname' => 'cloud'),
  ...
  array('uname' => 'orange', 'situation' => 'MAGE_DO', 'target_uname' => 'light_gray'),
  ...
  array('uname' => 'light_blue', 'situation' => 'GUARD_DO', 'target_uname' => 'light_gray'),
  ...
  #array('uname' => 'green', 'situation' => 'POISON_CAT_DO', 'target_uname' => 'dark_gray'),
  array('uname' => 'green', 'situation' => 'POISON_CAT_NOT_DO', 'target_uname' => NULL),
  array('uname' => 'purple', 'situation' => 'ASSASSIN_DO', 'target_uname' => 'black'),
  ...
  array('uname' => 'white', 'situation' => 'TRAP_MAD_DO',	'target_uname' => 'light_gray'),
