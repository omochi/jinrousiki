...
$RQ_ARGS->TestItems->test_users[2]->role = 'trick_mania';
...
$RQ_ARGS->TestItems->test_users[3]->role = 'fairy';
...
$RQ_ARGS->TestItems->test_users[5]->role = 'chain_poison lovers[5]';
...
$RQ_ARGS->TestItems->test_users[6]->role = 'boss_chiroptera';
...
$RQ_ARGS->TestItems->test_users[7]->role = 'trick_mania death_warrant[5]';
...
$RQ_ARGS->TestItems->test_users[9]->role = 'chiroptera upper_luck possessed[3-8]';
...
$RQ_ARGS->TestItems->test_users[10]->role = 'sirius_wolf lovers[5]';
...
$RQ_ARGS->TestItems->test_users[11]->role = 'cursed_fox';
...
$RQ_ARGS->TestItems->vote_night = array(
  ...
  #array('uname' => 'light_gray', 'target_uname' => 'dark_gray',     'situation' => 'GUARD_DO'),
  #array('uname' => 'light_gray', 'target_uname' => 'dark_gray',     'situation' => 'DREAM_EAT'),
  ...
  #array('uname' => 'light_gray',  'target_uname' => 'yellow',  'situation' => 'FAIRY_DO'),
  #array('uname' => 'light_gray',  'target_uname' => 'dark_gray',  'situation' => 'POSSESSED_DO'),
  ...
  array('uname' => 'dark_gray',  'target_uname' => 'light_blue',  'situation' => 'FAIRY_DO'),
  ...
  #array('uname' => 'light_blue', 'target_uname' => 'light_gray',     'situation' => 'ANTI_VOODOO_DO'),
