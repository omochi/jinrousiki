...
class MainRoleList{
  ...
  var $hunter_guard = array(
    'message' => "[役割] [|村人|陣営] [#狩人#系]\n　あなたは#猟師#です。#護衛#先が_妖狐_なら#狩る#ことができますが、^人狼^に襲撃された場合は殺されてしまいます。\n　あなたには二つの道が与えられました。身代わりの盾と、_妖狐_を討つ剣。あなたの選択が村を救うのです！",
    'delimiter' => array('|' => array('R' => 96, 'G' => 96, 'B' => 96),
			 '#' => array('R' => 51, 'G' => 153, 'B' => 255),
  ...
  var $blind_guard = array(
    'message' => "[役割] [|村人|陣営] [#狩人#系]\n　あなたは#夜雀#です。#狩り#能力はありませんが、#護衛#先を襲撃した人外を_目隠し_にして撃退することができます。",
    'delimiter' => array('|' => array('R' => 96, 'G' => 96, 'B' => 96),
			 '#' => array('R' => 51, 'G' => 153, 'B' => 255),
...
",
  ...
  var $jealousy = array(
    'message' => "[役割] [村人陣営] [|橋姫|系]\n　あなたは|橋姫|です。#恋人#が揃ってあなたに_処刑_投票してきたら^ショック死^させることができます。妬みの力で#恋人#を滅ぼすのです。",
  ...
  var $poison_wolf = array(
    'message' => "[役割] [|人狼|陣営] [|人狼|系]\n　あなたは|毒狼|です。たとえ#処刑#されても体内に流れる_毒_で村人一人を道連れにできます。強気に村をかく乱するのです！",
    'delimiter' => array('|' => array( 'R' => 255, 'G' => 0, 'B' => 0),
			 '#' => array('R' => 153, 'G' => 153, 'B' => 0),
			 '_' => array('R' => 0, 'G' => 153, 'B' => 102)));
  ...
  var $emerald_wolf = array(
    'message' => "[役割] [|人狼|陣営] [|人狼|系]\n　あなたは|翠狼|です。|人狼|を襲撃した場合はあなたと#共鳴者#になります。孤立している仲間と思い通わす心の根を育てるのです！",
    'delimiter' => array('|' => array('R' => 255, 'G' => 0, 'B' => 0),
			 '#' => array('R' => 160, 'G' => 160, 'B' => 0)));
  ...
  var $miasma_fox = array(
    'message' => "[役割] [|妖狐|陣営] [|子狐|系]\n　あなたは|蟲狐|です。#処刑#されるか_人狼_に襲われたら、あなたを死なせた人からランダムで一人を^熱病^にさせることができます。\n　あなたは蟲毒をもった呪いの|狐|。幾百もの怨念が宿りしあなたを殺めた者は、死に至る無間の苦しみにのたうつことでしょう。",
    'delimiter' => array('|' => array('R' => 204, 'G' => 0, 'B' => 153),
			 '#' => array('R' => 153, 'G' => 153, 'B' => 0),
			 '_' => array('R' => 255, 'G' => 0, 'B' => 0),
			 '^' => array('R' => 51, 'G' => 204, 'B' => 255)));
  ...
  var $rose_angel = array(
    'message' => "[役割] [|恋人|陣営] [|天使|系]\n　あなたは|薔薇天使|です。初日の夜に誰か二人を|恋人|にすることができます。その二人が#男性#同士だった場合はさらに_共感者_にすることができます。\n　紅を帯びし薔薇の蕾を手に、戦地に有りし男たちの魂を繋ぐ事こそがあなたの存在意義。兜が置かれるその時こそ、平和の鐘が響く時なのです。",
    'delimiter' => array('|' => array('R' => 255, 'G' => 51, 'B' => 153),
			 '#' => array('R' => 0, 'G' => 0, 'B' => 255),
			 '_' => array('R' => 160, 'G' => 160, 'B' => 0)));
...
class SubRoleList{
  ...
  var $impatience = array('message' => "　あなたは|短気|です。#決定#力がありますが、_再投票_になると|ショック死|してしまいます。",
			'delimiter' => array('|' => array('R' => 51, 'G' => 204, 'B' => 255),
					     '#' => array('R' => 153, 'G' => 153, 'B' => 153),
					     '_' => array('R' => 153, 'G' => 153, 'B' => 0)));

  var $celibacy = array('message' => "　あなたは|独身貴族|です。#恋人#に_処刑_投票されると|ショック死|してしまいます。",
			'delimiter' => array('|' => array('R' => 51, 'G' => 204, 'B' => 255),
					     '#' => array('R' => 255, 'G' => 51, 'B' => 153),
					     '_' => array('R' => 153, 'G' => 153, 'B' => 0)));
  ...
  var $androphobia = array('message' => "　あなたは|男性恐怖症|です。#男性#に_処刑_投票すると|ショック死|してしまいます。",
			'delimiter' => array('|' => array('R' => 51, 'G' => 204, 'B' => 255),
					     '#' => array('R' => 0, 'G' => 0, 'B' => 255),
					     '_' => array('R' => 153, 'G' => 153, 'B' => 0)));

  var $gynophobia = array('message' => "　あなたは|女性恐怖症|です。#女性#に_処刑_投票すると|ショック死|してしまいます。",
			'delimiter' => array('|' => array('R' => 51, 'G' => 204, 'B' => 255),
					     '#' => array('R' => 255, 'G' => 51, 'B' => 153),
					     '_' => array('R' => 153, 'G' => 153, 'B' => 0)));

  var $panelist = array('message' => "　あなたは|解答者|です。不正解だったときは#出題者#に_処刑_投票してください。",
			'delimiter' => array('|' => array('R' => 51, 'G' => 204, 'B' => 255),
  ...
  var $lost_ability = array('message' => "　あなたは能力を失いました。", 'delimiter' => array());
...
#$image = MakeImage($gen, $list->blue_fox);
#$image = MakeImage($gen, $list->blue_wolf);
#$image = MakeImage($gen, $list->cursed_chiroptera);
#$image = MakeImage($gen, $list->dark_fairy);
#$image = MakeImage($gen, $list->light_fairy);
#$image = MakeImage($gen, $list->doll_master);
#$image = MakeImage($gen, $list->emerald_fox);
#$image = MakeImage($gen, $list->mirror_fairy);
