...
class MainRoleList{
  ...
  var $yama_necromancer = array(
    'message' => "[役割] [#村人#陣営] [|霊能者|系]\n　あなたは|閻魔|です。前日の死者の死因を知ることができます。\n　魂に沙汰を下すその力で死者に白黒はっきりつけてやりましょう！",
