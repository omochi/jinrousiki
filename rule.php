...
<tr>
<td>村人</td><td><?php echo $ROLE_IMG->GenerateTag('human'); ?></td>
</tr>

<tr>
<td class="wolf">人狼</td><td><?php $ROLE_IMG->DisplayImage('wolf'); ?>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('wolf_partner'); ?></td><td>人狼一号</td></tr></table>
</td>
</tr>

<tr>
<td class="mage">占い師</td><td><?php $ROLE_IMG->DisplayImage('mage'); ?>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('mage_result'); ?></td><td>村人一号</td><td><?php echo $ROLE_IMG->GenerateTag('result_human'); ?></td></tr></table>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('mage_result'); ?></td><td>人狼一号</td><td><?php echo $ROLE_IMG->GenerateTag('result_wolf'); ?></td></tr></table>
</td>
</tr>

<tr>
<td class="necromancer">霊能者</td><td><?php $ROLE_IMG->DisplayImage('necromancer'); ?>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('necromancer_result'); ?></td><td>村人一号</td><td><?php echo $ROLE_IMG->GenerateTag('result_human'); ?></td></tr></table>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('necromancer_result'); ?></td><td>人狼一号</td><td><?php echo $ROLE_IMG->GenerateTag('result_wolf'); ?></td></tr></table>
</td>
</tr>

<tr>
<td class="wolf">狂人</td><td><?php echo $ROLE_IMG->GenerateTag('mad'); ?></td>
</tr>

<tr>
<td class="guard">狩人</td><td><?php $ROLE_IMG->DisplayImage('guard'); ?>
<table class="view"><tr><td>占い師一号</td><td><?php echo $ROLE_IMG->GenerateTag('guard_success'); ?></td></tr></table></td>
</tr>

<tr>
<td class="common">共有者</td><td><?php $ROLE_IMG->DisplayImage('common'); ?>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('common_partner'); ?></td><td>共有者一号</td></tr></table></td>
</tr>

<tr>
<td class="fox">妖狐</td><td><?php $ROLE_IMG->DisplayImage('fox'); ?>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('fox_targeted'); ?></td></tr></table></td>
</tr>

<tr>
<td class="poison">埋毒者</td><td><?php echo $ROLE_IMG->GenerateTag('poison'); ?></td>
</tr>

<tr>
<td class="lovers">キューピッド</td><td><?php $ROLE_IMG->DisplayImage('cupid'); ?>
<table class="view"><tr><td><?php echo $ROLE_IMG->GenerateTag('cupid_pair'); ?></td><td>恋人一号 恋人二号</td></tr></table></td>
</tr>
...
<tr>
<td>権力者</td><td><?php echo $ROLE_IMG->GenerateTag('authority'); ?></td>
</tr>
