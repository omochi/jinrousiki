...
define('EXT_MOD', JINRO_ROOT.'/module');
...
function loadModule($name) {
  ...
  if(func_num_args() == 1){
	...
	return $GLOBALS[$name] = include(JINRO_INC . '/game_vote_functions.php');
      ...
      return false;
    case ROOM_CLASSES:
      return $GLOBALS[$name] = include(JINRO_INC . '/room_class.php');
    case USER_CLASSES:
    ...
    case FEEDENGINE_CLASSES:
      if (loadModule(RSS_CLASSES)) {
	return $GLOBALS[$name] = include(JINRO_INC . '/feedengine/feedengine.php');
      }
      return false;
    case RSS_CLASSES:
      define('MAGPIE_CACHE_DIR', JINRO_ROOT . '/feed/cache');
      return $GLOBALS[$name] = include(EXT_MOD . '/magpierss/rss_fetch.inc');
    }
    return false;
  }
  else {
