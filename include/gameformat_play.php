<?php
include_once(dirname(__FILE__).'/chatengine.php');
include_once(dirname(__FILE__).'/game_functions.php');
...
HEADER;
  ...
  function OutputRoleNotice() {
    ...
    elseif($self->IsRole('yama_necromancer')) $this->output .= $ROLE_IMG->GenerateTag($SELF->main_role); //閻魔
