...
<caption><a name="main_role">新役職早見表</a></caption>
  ...
  <tr>
    ...
    <td>人狼</td>
    <td>憑狼</td>
    <td class="ability">襲撃が成功したら襲撃した人を乗っ取る人狼。</td>
    <td>Ver. 1.4.0 α24</td>
  </tr>
  <tr>
...
○<a name="crisis_priest">預言者</a> (占い結果：村人、霊能結果：村人) [※調整中なので出現しません]
「鉄火場」が分かる特殊な司祭 (表示は「村人」)。
「鉄火場である」と判定された場合は、どの陣営が有利なのかメッセージが表示される。

[作成者からのコメント]
村の危機を告げる特殊な司祭です。
細かい条件の調整中なので実装されていますが登場しません。
...
もし、後追いした恋人が遺言で憑依先と恋人であると書いていた場合は
状況と矛盾することになります。

例12-1) A[憑狼][恋人] → B[村人]、C[村人][恋人]
死体：A が無残な死体で発見されました(死因：「誰かに憑依した」)
憑依：B[村人](A[憑狼][恋人])
C の恋人の相手が A から B に変わる (C 視点から憑依したことが分かる)

例12-2) A[憑狼] → B[村人][恋人]、C[村人][恋人]
死体：A が無残な死体で発見されました(死因：「誰かに憑依した」)
死体：C が恋人の後を追い自殺しました

例12-3) A[憑狼] → B[村人][恋人]、D[暗殺者] → C[村人][恋人]
死体：A が無残な死体で発見されました(死因：「誰かに憑依した」)
死体：C が無残な死体で発見されました(死因：「暗殺された」)
憑依：B[村人][恋人](A[憑狼])

この場合は、C が B と恋人であるという遺言を残していたとしても
夢求愛者が暗殺された場合と区別が付かなくなる。
...
例13-1) A[憑狼][小心者] → B[村人][天邪鬼]
B に憑依している A は天邪鬼になります。
(小心者の表示が消えて天邪鬼が表示されます)

例13-2) C[さとり] → A[憑狼] → B[村人] ← D[さとり]
