...
<caption>新役職早見表</caption>
  ...
  <tr>
    ...
    <td>村人</td>
    <td>村人</td>
    <td class="ability">毒持ちを吊ったときに、投票していたら解毒 (毒が発動しない) する。<br>
      解毒に成功すると次の日に専用のシステムメッセージが出る。</td>
    <td>Ver. 1.4.0 α12</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="ability">一度だけ夜に村人一人に罠を仕掛けることができる狂人。<br>
      罠を仕掛けられた人の元に訪れた人狼・狩人系・暗殺者は死亡する。<br>
      狩人に護衛されると殺される。</td>
    <td>Ver. 1.4.0 α18</td>
  </tr>
  <tr>
    <td><a href="#jammer_mad">月兎</a></td>
    <td><a href="#wolf_side">人狼</a></td>
    <td>村人</td>
    <td>村人</td>
  ...
  <tr>
    ...
    <td class="ability">初日の夜に誰か一人を選んでその人を<a href="#mind_read">サトラレ</a>にする。<br>
      投票結果が出るのは 2 日目以降で、<a href="#unconscious">無意識</a>の発言は読めない。</td>
    <td>Ver. 1.4.0 α21</td>
  </tr>
  <tr>
...
村人の性別を判別する特殊な占い師。
呪殺できないので呪返しも受けないが、月兎 (邪魔狂人)の影響は受ける。

※Ver. 1.4.0 α21〜
蝙蝠を占った場合は「蝙蝠」と判定される。

[作成者からのコメント]
精神鑑定士の話を出したときの流石鯖の管理人さんのコメントが
きっかけで生まれた役職です。
...
[作成者からのコメント]
呪い系統の対抗役職です。
積極的に呪狼・天狐・呪蝙蝠を探しに行く場合は普通の占い師と同じ感覚でいいですが
呪術師・九尾による占い師の呪返しを防ぐのが狙いなら、同時に同じ人を
...
結果として、同じ相手に再投票したのにショック死が出るケースが出てきます。
...
霊能結果が隠蔽されると、霊能者と雲外鏡の霊能結果が
「〜さんの死体が盗まれた」という趣旨のメッセージになる。
夢枕人は夢の中で判定を出すので火車の影響は受けない。
...
夜に投票した夢系能力者(夢見人、夢枕人、夢共有者、夢毒者) を殺すことができる狂人。
何らかの形で夢守人に接触した場合は殺される。
狩人に護衛されると殺される。
...
※Ver. 1.4.0 α19〜
全ての妖狐は銀狐以外の妖狐・子狐が誰か分かります。
銀狐以外の妖狐同士は夜に会話(念話)できます(他人からはいっさい見えません)が、
...
子狐との違いは占いができない代わりに他の妖狐と念話ができる事。

[作成者からのコメント]
白狼の狐版です。狼サイドからは村人と大差ないですが
村サイドにはかなりの脅威となるでしょう。
...
仲間が分からない妖狐。
(他の妖狐・子狐からも仲間であると分からない)

[作成者からのコメント]
銀狼 (次のリリースで登場予定) の妖狐版です。
...
という扱いになる。
精神鑑定士の結果は「正常」、ひよこ鑑定士の結果は「蝙蝠」となる。
...
本人か発言者が死んだら効力が切れます。
この役職はサブ役職非公開設定でも必ず表示されます。
現在、この能力がつくのは<a href="#self_cupid">求愛者</a>の矢を撃たれた相手だけです。
