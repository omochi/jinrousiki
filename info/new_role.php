...
<caption><a name="main_role">新役職早見表</a></caption>
  ...
  <tr>
    ...
    <td>村人<br>(呪殺無し)</td>
    <td>妖狐</td>
    <td class="ability">呪殺されないが人狼には食べられてしまう妖狐。</td>
    <td>Ver. 1.4.0 α17</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="ability">一度だけ夜に村人一人に罠を仕掛けることができる狂人。<br>
      罠を仕掛けた人の元に訪れた人狼・狩人系(狩人、騎士、ブン屋)<br>
      暗殺者は死亡する。狩人に護衛されると殺される。</td>
    <td>Ver. 1.4.0 α18</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>村人</td>
    <td>村人</td>
    <td class="ability">護衛した人の厄を祓う(占い妨害と呪返しを防ぐ)特殊な狩人。<br>
  ...
  <tr>
    ...
    <td>人狼</td>
    <td>憑狼</td>
    <td class="ability">噛んだ人を乗っ取る人狼。(作成中につき、まだ出現しません)</td>
    <td>Ver. 1.4.0 α24</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>人狼<br>(呪殺無し)</td>
    <td>妖狐</td>
    <td class="ability">占い結果が人狼、霊能結果が妖狐と判定される妖狐。</td>
    <td>Ver. 1.4.0 α24</td>
  </tr>
  <tr>
...
例1) A[憑狼] → B[村人]
A が「無残な死体」で発見される (死因は「A は誰かに憑依したようです」)。
B の中の人は霊界へ。
A の発言は B が発言したように見える。
...
例3-1) A[憑狼] → B[村人]、C[占い師] → B[村人]
占い結果：B は「村人」でした。

例3-2) C[占い師] → B[村人](A[憑狼]が憑依中)、D[人狼] → E[村人]
占い結果：B は「人狼」でした。

例3-3) C[精神鑑定士] → B[狂人](A[憑狼]が憑依中)、D[人狼] → E[村人]
鑑定結果：B は「正常」でした。

例3-4) A[憑狼] → B[白狐]、C[魂の占い師] → B[白狐]
占い結果：B は「白狐」でした。

例3-5) A[憑狼] → B[村人]、C[ブン屋] → B[村人]
死体：A が無残な死体で発見されました(死因：「誰かに憑依した」)
尾行結果：B は A に襲撃されました。
この場合、ブン屋視点で B が憑依されていることが確定する。

例3-6) C[薬師] → B[埋毒者](A[憑狼]が憑依中)
鑑定結果：B は「毒を持っていません」。

例3-7) C[暗殺者] → B[村人](A[憑狼]が憑依中)
死体：B が無残な死体で発見されました(死因：「暗殺された」)
実際に死ぬのは A[憑狼]。

例3-8) A[憑狼] → B[村人]、C[暗殺者] → B[村人]
死体：A が無残な死体で発見されました(死因：「誰かに憑依した」)
この場合、暗殺者視点で B が憑依されていることが確定する。

例3-9) C[銀狼] → B[村人](A[憑狼]が憑依中)
死体：無し
...
5. 占い師による憑依キャンセル
占い師と魂の占い師が憑狼を占った場合は、憑依がキャンセルされます。
夢見人や子狐が占ってもキャンセルされません。

例) A[憑狼] → B[村人]、C[占い師] → A[憑狼]
占い結果：A は「人狼」でした。
...
6. 毒噛みについて
憑狼が毒能力者を襲撃して自分が毒に当たったら憑依がキャンセルされます。

例6-1) A[憑狼] → B[埋毒者]、毒死：A
死体：A が無残な死体で発見されました(死因：「毒に中った」)
死体：B が無残な死体で発見されました(死因：「人狼に襲撃された」)

例6-2) A[憑狼] → B[埋毒者]、毒死：C[人狼]
死体：A が無残な死体で発見されました(死因：「誰かに憑依した」)
...
例7) A[憑狼] → B[村人][恋人]、C[村人][恋人]
死体：A が無残な死体で発見されました(死因：「誰かに憑依した」)
死体：C が恋人の後を追い自殺しました

もし、C が遺言で「B と恋人だった」と書いていた場合は矛盾が生じることになる。
C が嘘をついていない前提なら、B が憑依されているか
C が夢求愛者かのどちらかになる。
...
例8-1) A[憑狼][小心者] → B[村人][天邪鬼]
B に憑依している A は天邪鬼になります。
(小心者の表示が消えて天邪鬼が表示されます)

例8-2) A[憑狼][サトラレC] → B[村人][サトラレD]、C[さとり]、D[さとり]
C は A の発言が見えなくなります。
D は B になりすましている A の発言が見えます。

[作成者からのコメント]
長期で実在する特殊狼です。
作りかけなのにこの量の説明書きが必要と言う時点でこの役職の
複雑さが想像できるかと思います。
