...
<ol>
  ...
  <ul>
    ...
    <li>白狼(大狼)の実装 (真・闇鍋モード時に低確率で出現します)</li>
    <li>魂の占い師(役職占い師)の実装 (真・闇鍋モード時に低確率で出現します)</li>
    <li>子狐(呪殺されない代わりに噛まれる狐)の実装 (真・闇鍋モード時に低確率で出現します)</li>
    <li>巫女(突然死した人の所属陣営が分かる霊能もどき)の実装 (真・闇鍋モード時に低確率で出現します)</li>
    <li>狂信者(人狼がわかる狂人)の実装 (真・闇鍋モード時に低確率で出現します)</li>
    <li>騎士(吊りでは発動しない毒＋狩人)の実装 (真・闇鍋モード時に低確率で出現します)</li>
    <li>ネタ系サブ役職を色々実装</li>
    <li>複数キューピッドの実装</li>
  </ul>
