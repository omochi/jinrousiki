...
<tr id="rule_role_cupid">
  ...
  <td><div>
    ...
    キューピッドは村作成の時にオプションとして設定され、村の人数 [<?php echo CastConfig::$cupid ?>人] 以上で登場します。
  </div></td>
</tr>
<tr id="rule_role_decide">
  ...
  <td><div>
    ...
    決定者は村作成の時にオプションとして設定され、村の人数 [<?php echo CastConfig::$decide ?>人] 以上で登場します。
  </div></td>
</tr>
<tr id="rule_role_authority">
  ...
  <td><div>
    ...
    兼任となり、他の役割のオプションとして付きます。<br>
    権力者は村作成の時にオプションとして設定され、村の人数 [<?php echo CastConfig::$authority ?>人] 以上で登場します。
  </div></td>
</tr>
<tr id="rule_role_lovers">
  ...
  <td><div>
    ...
    兼任となり、他の役割のオプションとして付きます。<br>
    恋人は村作成の時にオプションとしてキューピッドが登場するように設定され、村の人数 [<?php echo CastConfig::$cupid ?>人] 以上で登場します。
  </div></td>
</tr>
</table>
<br>
...
ただし、村の総人数が [<?php echo GameConfig::$cupid_self_shoot ?>人] に満たない場合は、必ず自分と誰かを指定してください。<br>
...
「異議あり」ボタンのカッコの中の数字は残り回数でゲーム開始前から通算で [<?php echo GameConfig::$objection ?>回] しか使用できません。<br>
<br>
