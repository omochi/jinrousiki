...
<ol>
  ...
  <li>悪戯先が人狼に襲撃されると発動するタイプは、<a href="wolf.php#hungry_wolf">餓狼</a>・<a href="wolf.php#possessed_wolf">憑狼</a>による襲撃だと無効になります。</li>
...
<h4>[作成者からのコメント]</h4>
<pre>
東方 Project のスターサファイアがモチーフの、<a href="#flower_fairy">花妖精</a>の星バージョンです。
</pre>
