...
<h3>ユーザの似顔絵などを表すユーザアイコンを自由にアップロードできます</h3>
<div class="info">
...
<h3>死亡して天国モードに行く場合に画面がおかしくなる</h3>
<div class="info">
...
<h3>死亡者のアイコンにマウスポインタを乗せると画像が異常に大きくなる</h3>
<div class="info">
...
<h3>バグを見つけたのですが</h3>
<div class="info">
<a href="http://cgi.f45.aaacafe.ne.jp/~netfilms/" target="_blank">公式</a>の連絡用掲示板にできるだけ詳しくバグの起きた状況とその内容を報告してください。<br>
できれば対戦ログも教えていただければ助かります。
</div>

<h3>ゲームの機能に関して要望があるのですが</h3>
<div class="info">
私にやる気があればなんとかしたいと思っています。<br>
でもあまり期待しないでください|´・ω・)
</div>

<h3>発言したときに時々発言できてないときがある</h3>
<div class="info">
...
<h3>同じ日の夜に占い師が妖狐を占い、その占い師を人狼が喰い殺した場合どうなるの？</h3>
<div class="info">
通常占い師が妖狐を占うと占われた妖狐は死んでしまいますが、同日に人狼がその占い師を襲うと占いは失敗となり妖狐は死なずに済みます。<br>
勝率の低い妖狐のバランスを取るためにこのようになっています。
</div>

<h3>Kickされたときのユーザ名や村人名は再度同じ村で使用できるの？</h3>
<div class="info">ユーザ名は使用できませんが、村人名は使用できます。</div>

<h3>このスクリプトを勝手に改造して再配布してもいいの？</h3>
<div class="info">
かまいません。<br>
