...
突然死は、昼なら12時間、夜なら6時間のゲーム内仮想時間を経過した後に<?php echo $TIME_CALC->sudden_death; ?>経過すると投票していない人は自動で突然死となります。<br>
突然死が発生するとその日の投票がリセットされて再投票となります、注意してください。</div>


<h2>ユーザの似顔絵などを表すユーザアイコンを自由にアップロードできます</h2>
<div class="diff">専用のページから<?php echo $USER_ICON->IconSizeMax() . "、容量 ", $USER_ICON->IconFileSizeMax(); ?>
のファイルをアップロードできます。</div>


<h2>自動廃村</h2>
<div class="diff">ゲームが開始されない場合、最後に発言された時間から<?php echo $TIME_CALC->die_room; ?>
